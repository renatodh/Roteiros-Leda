...
public class AVLCountAndFillImpl<T extends Comparable<T>> extends
	...
	private void pivotRecursivo(T[] array, ArrayList<T> aux, int inicio, int fim) {
		if (fim - inicio > 0) {
			int meio = (inicio+fim) / 2;
			aux.add(array[meio]);
			this.pivotRecursivo(array, aux, inicio, meio);
			this.pivotRecursivo(array, aux, meio+1, fim);
		}
	}}